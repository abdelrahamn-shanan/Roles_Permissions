                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('articles.update',$article->id) }}">
                        ...
                        <div>
                            ...
                            <textarea id="text" class="block mt-1 w-full" name="text" autofocus>{{ old('text', $article->text) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="author" class="block mt-1 w-full" type="text" name="author" :value="old('author',$article->author)" autofocus />
